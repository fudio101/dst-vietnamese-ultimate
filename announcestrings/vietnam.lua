--[[
================================================================================
                    DON'T STARVE TOGETHER - VIETNAMESE ANNOUNCE STRINGS
================================================================================
File: announcestrings/vietnam.lua
Mục đích: Cung cấp bản dịch tiếng Việt cho hệ thống thông báo trạng thái
Tác giả: Shinosan & nqtonj
================================================================================
]]

-- Tải bản dịch chính từ file .po
...
================================================================================
Cấu trúc:
- _ : Phần chung (templates, utilities)
- [CHARACTER_NAME] : Thông báo riêng cho từng nhân vật
  - HUNGER/SANITY/HEALTH/WETNESS : 4 loại trạng thái
    - FULL/HIGH/MID/LOW/EMPTY : 5 mức độ (từ tốt nhất đến tệ nhất)
================================================================================
]]
...
ANNOUNCE_STRINGS = {
    ...
    --[[
    ============================================================================
                            PHẦN CHUNG - TEMPLATES & UTILITIES
    ============================================================================
    Chứa các hàm tiện ích và template để tạo thông báo động
    ]]
    _ = {
        -- Hàm xử lý mạo từ cho tiếng Việt (luôn dùng "một")
        getArticle = function(name)
            return " một"
        end,

        -- Tiếng Việt không có số nhiều phức tạp như tiếng Anh
        S = "",
        -- Tên các chỉ số trạng thái
        STAT_NAMES = {
            Hunger = "Hunger",
            Sanity = "Sanity",
            Health = "Health",
        ...
        --[[
        Template thông báo vật phẩm
        VD: "Tôi có 6 papyrus trong rương này với 50% độ bền."
        ]]
        ANNOUNCE_ITEM = {
            ...
            IN_THIS = " trong ",
            WITH = " với ",
            AND_THIS_ONE_HAS = ", và cái này có ",
            AND_THIS_ONE_IS = ", và cái này có ",
            ...
            -- Template cho thông tin còn lại
            REMAINING = {
                DURABILITY = "còn {AMOUNT} lần dùng",
                FRESHNESS = "còn {AMOUNT} ngày",
                RECHARGE = "{AMOUNT} cho đến khi sạc đầy",
            },

            -- Trạng thái đá nhiệt (Thermal Stone)
            HEATROCK = {
                "lạnh như băng", -- Lạnh nhất
                "lạnh", -- Lạnh
        ...
        --[[
        Template thông báo công thức chế tạo
        VD: "Tui sẽ làm một rìu."
            "Liệu ai đó có thể giúp mình một máy khoa học?"
        ]]
        ANNOUNCE_RECIPE = {
            FORMAT_STRING =
            "{START_Q}{TO_DO}{THIS_MANY} {ITEM}{S}{PRE_BUILT}{END_Q}{I_NEED}{A_PROTO}{PROTOTYPER}{FOR_IT}.",

            START_Q = "",
            END_Q = "?",

            -- Các động từ hành động
            I_HAVE = "Tui coá ", -- Đã có sẵn
            ILL_MAKE = "Tui sẽ làm ", -- Biết công thức + có nguyên liệu
            CAN_SOMEONE = "Liệu ai đó có thể giúp mình ", -- Chưa biết công thức
            WE_NEED = "Chúng mình cần thêm ", -- Biết công thức nhưng thiếu nguyên liệu

            -- Các từ bổ sung
            PRE_BUILT = " được xây dựng sẵn và sẵn sàng để đặt",
            I_NEED = " Tôi sẽ cần ",

            -- Hàm trích xuất tên máy prototype từ tooltip
        ...
        --[[
        Template thông báo nguyên liệu
        VD: "Tui cần 2 thêm đá cắt và máy khoa học để làm máy giả kim."
        ]]
        ...
        --[[
        Template thông báo skin
        VD: "Tôi có skin Tragic Torch cho Torch."
        ]]
        ANNOUNCE_SKIN = {
            FORMAT_STRING = "Tôi có skin {SKIN} cho {ITEM}.",
        },
        --[[
        Template thông báo nhiệt độ
        VD: "Tôi nóng vãi!" hoặc "Quái thú lạnh thấy bà nội!"
        ]]
        ANNOUNCE_TEMPERATURE = {
            ...
            PRONOUN = {
                DEFAULT = "Tôi",
                BEAST = "Quái thú", -- Dành cho Werebeaver (Woodie biến hình)
            },

            TEMPERATURE = {
                BURNING = "nóng vãiiiii!", -- Cháy
                HOT = "nóng thật!", -- Nóng
                WARM = "nóng sương sương", -- Ấm
                GOOD = "ổn áp phết", -- Thoải mái
                COOL = "lạnh sương sương", -- Mát
                COLD = "lạnh thật!", -- Lạnh
                FREEZING = "lạnh thấy bà nội!", -- Cóng
            },
        },
        -- Các template khác
    ...
    --[[
    ============================================================================
                            THÔNG BÁO RIÊNG THEO NHÂN VẬT
    ============================================================================
    Mỗi nhân vật có 4 loại trạng thái: HUNGER, SANITY, HEALTH, WETNESS
    Mỗi trạng thái có 5 mức độ: FULL, HIGH, MID, LOW, EMPTY (từ tốt → tệ)
    ]]
    -- ========================================================================
    -- NHÂN VẬT MẶC ĐỊNH (khi không xác định được nhân vật cụ thể)
    -- ========================================================================
    UNKNOWN = {
        HUNGER = {
            FULL  = "Suýt bội thực luôn rồi :0", -- >75%
            HIGH  = "No căng bụng trùng da mắt :>", -- >55%
            MID   = "Đói sương sương, nhưng dễ hẹo lắm nếu không có đồ ăn kịp thời", -- >35%
            LOW   = "Đói vãi ò, ae cứu với", -- >15%
            EMPTY = "Tuyệt thực tới chết x.x", -- <15%
        },
        SANITY = {
            FULL  = "Tỉnh như sáo cậy @.@", -- >75%
            HIGH  = "Còn tỉnh chán, yên tâm", -- >55%
            MID   = "Não thấy sắp cút rồi á :<", -- >35%
            LOW   = "Não sắp cút thật rồi", -- >15%
            EMPTY = "Chết não", -- <15%
        },
        HEALTH = {
            FULL  = "Sẵn sàng khô máu bất cứ điều gì", -- 100%
            HIGH  = "Thương có tí, chạ làm seo!!", -- >75%
            MID   = "Tui sắp cút rồi ae", -- >50%
            LOW   = "Thôi bú cái gì hồi máu nhanh lên chứ cút thật bây giờ tôi ơi.", -- >25%
            EMPTY = "Cút luôn rồi", -- <25%
        },
        WETNESS = {
            FULL  = "Ướt như chuột lột!", -- >75%
            HIGH  = "Ướt!", -- >55%
            MID   = "Quần áo của tôi bị ướt.", -- >35%
            LOW   = "Oh, H2O.", -- >15%
            EMPTY = "Khô ráo.", -- <15%
        },
        BOAT = {
    ...
    -- ========================================================================
    -- NHÓM NHÂN VẬT CHÍNH - Original Characters
    -- ========================================================================

    -- Wilson - Nhà khoa học (Gentleman Scientist)
    WILSON = {
        HUNGER = {
            FULL  = "Tôi no căng!",
    ...
    -- Wolfgang - Người khổng lồ (The Mighty)
    WOLFGANG = {
        HUNGER = {
    ...
    -- WX-78 - Robot tự động (The Soulless Automaton)
    WX78 = {
        HUNGER = {
            FULL  = "ĐỘ NO >75%",
            HIGH  = "ĐỘ NO >55%",
    ...
    -- Wickerbottom - Thủ thư (The Librarian)
    WICKERBOTTOM = {
        HUNGER = {
    ...
    -- Woodie - Người Canada (The Lumberjack)
    WOODIE = {
        HUMAN = {
            HUNGER = {
                FULL  = "No căng rồi!",
    ...
    -- Wes - Nghệ sĩ tạp kỹ câm (The Silent)
    WES = {
        HUNGER = {
            FULL  = "...",
            HIGH  = "...",
    ...
    -- Maxwell - Vua bóng tối (The Shadow Puppet Master)
    WAXWELL = {
        HUNGER = {
    ...
    -- ========================================================================
    -- NHÓM NHÂN VẬT DST - Don't Starve Together Exclusive
    -- ========================================================================

    -- Webber - Cậu bé nhện (The Indigestible)
    WEBBER = {
        HUNGER = {
    ...
    -- Wigfrid - Nữ chiến binh (The Performance Artist)
    WATHGRITHR = {
        HUNGER = {
    ...
    -- Winona - Thợ cơ khí (The Handywoman)
    WINONA = {
        HUNGER = {
    ...
    -- ========================================================================
    -- NHÓM NHÂN VẬT SHIPWRECKED - Don't Starve: Shipwrecked DLC
    -- ========================================================================

    -- Walani - Cô gái lướt sóng (The Surfer)
    WALANI = {
        HUNGER = {
    ...
    -- Woodlegs - Thuyền trưởng cướp biển (The Captain)
    WOODLEGS = {
        HUNGER = {
    ...
    -- Wilbur - Vua khỉ (The Monkey King)
    WILBUR = {
        HUNGER = {
    ...
    -- ========================================================================
    -- NHÓM NHÂN VẬT MỚI - Recent Characters
    -- ========================================================================

    -- Wormwood - Người cây (The Lonesome) - Chỉ nói "Tôi là Groot"
    WORMWOOD = {
        HUNGER = {
    ...
    -- Wurt - Cô bé người cá (The Mer-maid)
    WURT = {
        HUNGER = {
    ...
    -- Wortox - Quỷ nhỏ nghịch ngợm (The Soul Starved)
    WORTOX = {
        HUNGER = {
    ...
    -- Wanda - Pháp sư thời gian (The Timekeeper)
    WANDA = {
        HUNGER = {
    ...
    -- Walter - Cậu bé hướng đạo (The Fearless)
    WALTER = {
        HUNGER = {
        ...
        HEALTH = {
            ...
            LOW   =
            "Ôí dồi ôi, Làng nước ơi, ba má ơi, cứu con với, con sắp chớt rồi, cứuuuuuu vớiiiii, WODYYYY CHẠY ĐIIIII",
...
================================================================================
                                    KẾT THÚC FILE
================================================================================
Tổng cộng: ~20 nhân vật với đầy đủ thông báo trạng thái bằng tiếng Việt
Cập nhật cuối: 2024
================================================================================
]]
