...
ANNOUNCE_STRINGS = {
	...
	WALTER = {
		...
		HEALTH = {
			FULL  = "Mặc dù không bị tổn thương thể xác gì cả nhưng tui dễ bị tổn thương tinh thần lắm á, tốt nhất là việc oánh nhau tui để cho mọi người giải quyết teehee~",
